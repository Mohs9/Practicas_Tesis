...
Nielsen y Chuang {\cite{nielsen_chuang_2010}} proponen la siguiente situación. Supóngase que $\mathcal{M}$ es un observable en el sistema de Hilbert $\mathcal{H}_A$ y se tiene algún dispositivo de medición, el cual es capaz de realizar la medición de $\mathcal{M}$\cpnote{Frase inconclusa} \rrnote{ya lo he corregido}. Además, sea $\tilde{\mathcal{M}}$ un observable para la
...
dispositivo de medición debe proporcionar  el resultado $m$ con una probabilidad igual a uno. \cpnote{Esta frase tambien esta rara. Porfa checa de aca en adelante
y pule}\rrnote{ya he revisado la redacción del resto del párrafo.} En consecuencia, si $P_m$ es el operador de proyección al
