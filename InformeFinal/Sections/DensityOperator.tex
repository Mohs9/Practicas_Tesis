...
medición de $\mathcal{M}$\cpnote{Frase inconclusa}. Sea $\tilde{\mathcal{M}}$ un observable para la
...
con probabilidad uno\cpnote{Esta frase tambien esta rara. Porfa checa de aca en adelante
y pule}. En consecuencia, si $P_m$ es el operador de proyección al
