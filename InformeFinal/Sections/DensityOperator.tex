...
realizar la medición de $\mathcal{M}$. Además, sea $\tilde{\mathcal{M}}$ un observable para la
...
probabilidad igual a uno.  En consecuencia, si $P_m$ es el operador de proyección al
