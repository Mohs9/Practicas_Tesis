...
%Se realizó un programa que mapea un operador de estado inicial a un estado final después de una medición difusa, que se describe con la descomposición en operadores de Kraus de la medida POVM descrita, con el que se pueden obtner varios ejemplos. El programa se puede obtener en \href{}{este enlace}.
