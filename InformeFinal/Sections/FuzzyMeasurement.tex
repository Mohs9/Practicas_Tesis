...
Con una probabilidad $q$ el instrumento cuántico es \[\sum_{a_j,b_k}P_{a_j,b_k}\otimes P_{a_j,b_k}\] y con una probailidad $(1-q)$ es \[\sum_{a_j,b_k} P_{a_j,b_k}\otimes \frac{1}{2} P'_{a_j,b_k}.\]
