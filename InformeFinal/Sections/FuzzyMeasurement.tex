...
Notar que el sistema clásico indica la salida de le medición y este siempre indica el estado de salida correctamente.

\subsubsection{Segunda alternativa}


En la segunda alternativa se aplica el operador difuso al sistema clásico que se interpreta como si los resultados de la medición son los que se intercambian, y el sistema cuántico es simplemente aplicar una medición proyectiva. \begin{equation}
    \begin{split}
