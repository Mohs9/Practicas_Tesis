...
Sin embargo, el problema es que también se necesita la descripción del estado
...
frase. Mas bien, quieres mas informacion que los operadores E alpha}. Es por
...
$K_\alpha=\sqrt{E_\alpha}$\cpnote{no se si lo digas mas adelante, 
pero es importante decir que esa evaucion tiene infinitas soluciones}. Luego de introducir los operadores de Kraus el
...
ideas. Quizá separa}. Para esta medida POVM los operadores de
...
Claramente la descomposición en operadores de Kraus no es única debido a que al
multiplicar por la derecha alguna matriz unitaria $U$, $UK_{a_j,b_k}$ también
será un nuevo operador de Kraus que cumpla con definir la misma medida POVM\@\cpnote{
ok esto se puede explicar mas arriba creo y quizá recordar acá (o no).
...
varios ejemplos. El programa se puede obtener en
\href{https://github.com/Mohs9/Practicas_Tesis/blob/d751cf4a3b187f124057c927433b29aa6d918ef1/InformeFinal/Code/POVM.nb}{\textit{este
enlace}
}. \cpnote{Creo qeu toca poner algo qeu indique con colores que hay un enalice o quizá ponerlo 
en la bibliografía y de ahi el enlace.}
...
\cpnote{Quisiera que comentaras, resaltaras y analizaras las diferencias.}
Claramente la ecuación {\ref{traza_SP_ejemplo1}} difiere de la ecuación {\ref{traza_S1_ejemplo1}}, % de {\ref{traza_S2_ejemplo1}} y {\ref{traza_S3_ejemplo1}}, 
...
La \cpnote{Mas bien Una descompo...}descomposición de estos operadores por tanto son las siguientes
\begin{equation}
    \begin{split}
