...
Con una probabilidad $q$ el instrumento cuántico es \[\sum_{a_j,b_k}P_{a_j,b_k}\otimes P_{a_j,b_k}\rho P_{a_j,b_k}\] y con una probabilidad $(1-q)$ es \[\sum_{a_j,b_k} P'_{a_j,b_k}\otimes \frac{1}{2} P'_{a_j,b_k}\rho P'_{a_j,b_k}.\]
...
\begin{equation}
    \mathcal{I}_3(\rho)=\sum_{a_j,b_k} q [P_{a_j,b_k}\otimes P_{a_j,b_k}\rho P_{a_j,b_k}]+ (1-q)[P'_{a_j,b_k}\otimes \frac{1}{2}P'_{a_j,b_k} \rho  P'_{a_j,b_k}].
\end{equation}  
...
Para la tercera alternativa tanto el efecto de la medición como el mapeo de las probabilidades es distinto al de las otras dos alternativas. Primero hay que notar que para este caso $P'_{00}=2P_{00}$,$P'_{11}= 2P_{11}$ y $P'_{10}=P'_{01}$ \begin{equation}\label{tercera_alternativa_ejemplo1}
    \begin{split}
