...
Debido a que en la naturaleza es posible obtener mediciones imperfectas \cpnote{no entiendo 
este comentario, osea, si es cierto, pero esun poco vacio}, en
...
el estado posterior a la medición del sistema \cpnote{Creo que lasdos frases anteriores
deben ir unidas}. Por lo que, en este contexto es
...
proyectivas y que permiten un efecto más suave en el sistema medido \cpnote{Tengo problemas
con iniciar una frase con ``por lo que''. Croe que se usa a la mitad de una frase. 
Si vas a comenzar una frase, prefiero que comiences de otra manera}.
...
medidas POVM\@. \cpnote{Es costumbre abrir el parrafo con lo mas importante. En 
este caso me parece que es importante decir porqué vamos a usar el lenguaje de las 
operaaciones cuanticas. Un poco como tu ultima frase. Abre el parrafo 
con un refraseo de lo ultimo y adapta. }

\cpnote{Estas pasando como por la estructura general del trabajo. Sin embargo 
no hablas del capitulo 4 sino dos frases en la parte de la estructura. Te propongo que 
armes un parrafo hablando del 4, y que quizá elimines el siguiente parrafo, indicando en los 
parrafos anteriores donde va, por ejemplo, lo de los POVMs.}
