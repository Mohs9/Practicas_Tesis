...
%Debido a que en la naturaleza es posible obtener mediciones imperfectas
 \cpnote{no entiendo este comentario, osea, si es cierto, pero esun poco vacio},\rrnote{Borré el comentario que estaba demás.} 
...
respectivas de los diferentes resultados posibles de la medición, además debe  especificar el estado posterior a la medición del sistema. 
 \cpnote{Creo que las dos frases anterioresdeben ir unidas}. \rrnote{uní las frases.}
...
\cpnote{Tengo problemas con iniciar una frase con ``por lo que''. Croe que se usa a la mitad de una frase. Si vas a comenzar una frase, prefiero que comiences de otra manera}.\rrnote{Ya cambie el inició de las frases que empezaban con ``por lo que''}
...
\rrnote{Cambié el orden del párrafo y lo adapté.}
