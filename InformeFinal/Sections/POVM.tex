...
\end{equation} 
donde la segunda inecuación \cpnote{esa palabra no existe en español. Cambiala
por desigualdad.} se obtiene de la observación \[ \la
...
caso especial de estas últimas\cpnote{Esta frase suena contradictoria. Porfa arreglala}. Dado cualquier POVM puro con $k$ elementos y un
...
$\Pi=\sum _{i=1}^{n}{\sqrt {E_{i}} }_{H}\otimes {|i\rangle }_{H'}$\cpnote{Mejora 
la redaccion de esta frase}. La
