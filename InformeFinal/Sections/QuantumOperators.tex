...
estas indeseadas interacciones se presentan como ruido en información cuántica\cpnote{No
es buen estilo repetir palabras sin un buen motivo. Puedes partir esta frase en 
dos y decir ``... exterior. Éstas se presentan...'' es mas, no diría ``presentan''
pues creo que no es lo que quieres decir}.
...
abiertos \cpnote{nop, ese no es el motivo...}. Otra de las aplicaciones de las operaciones cuánticas en información
...
\cite{nielsen_chuang_2010}. \cpnote{Este ultimo mensaje me parece valioso, pero trata
de hacer mas lógico y sincero este parrafo}
...
sistema cuántico. \cpnote{De como viene el escrito, parece qeu esta tercera
sección está fuera de contexto. Trata de hilar mejor esta idea. De hecho no se porque 
la vas a discutir... }
...
\cpnote{porque ``por lo tanto''? no veo porque... quizá escribiste esta seccion un poco cansada
porfa revisa.} se
