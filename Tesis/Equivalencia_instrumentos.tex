...
%De otra forma, con la misma idea se ve que si el operador de densidad conmuta con $A\otimes B$, es decir que \[\rho=\sum_{j,k} (\tr(\rho P_{a_j, b_k})) P_{a_j, b_k},\] de nuevo sin importar cuales sean sus valores propios.
