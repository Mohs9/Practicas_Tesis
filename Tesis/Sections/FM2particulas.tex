...
\begin{equation}
    \begin{split}
        \mathcal{I}: \mathcal{H}_{\text{qu}}\mapsto \mathcal{H}_{\text{cl}}\otimes \mathcal{H}_{\text{qu}},\\
...
El instrumento cuántico a considerar es aplicar el operador difuso definido en la ecuación ({\ref{operador_difuso}}) al estado inicial y luego aplicarle una medida proyectiva, para modelar el sistema cuántico, como  si las partículas se intercambian.\begin{equation}\label{fisrtinstrument}
    \begin{split}
...
%\begin{corollary}
 %   Para todo estado inicial $\rho$ si los observables $A\tensor B$ y $B\tensor A$ son no degenerados y conmutan entonces ambos instrumentos son equivalentes.
%\end{corollary}
