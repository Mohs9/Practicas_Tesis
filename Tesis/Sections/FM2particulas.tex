\chapter[MEDICIONES DIFUSAS PARA SISTEMAS DE DOS PARTÍCULAS]{2. MEDICIONES DIFUSAS PARA SISTEMAS DE DOS PARTÍCULAS}
% Intro {{{
...
\subsection{Otras aproximaciones utilizando instrumento cuánticos} % {{{
...
Las mediciones difusas se pueden entender utilizando el siguiente instrumento cuántico. 
...
En esta sección se explorarán un ejemplo numérico, con un operador particular y utilizando la medida POVM propuesta en la sección {\ref{Sec_POVM_para_mediciones_difusas}} y el instrumento cuántico propuesto en la sección anterior.
