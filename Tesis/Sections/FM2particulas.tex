...
\rrnote{Se plantea la definición matemática del instrumento cuántico.}
...
\rrnote{Se describe como obtener el mapeo de las salidas y del estadao posterior, usando las trazas parciales de los sistemas cuánticos y clásicos respectivamente.}
...
\rrnote{El valor esperado de un instrumento (debería profundizar.)}
...
\end{equation}%donde el subíndice <<cl>> indica que el observable se multiplica por el sistema clásico y el subíndice <<qu>> indica que la identidad está en el espacio cuántico. 
\rrnote{Se explica el primer instrumento y su valor esperado}
...
\rrnote{Se explica el segundo  instrumento, su interpretación y su valor esperado.}
