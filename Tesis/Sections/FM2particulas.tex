...
\rrnote{Párrafo 4: Como ejemplo concreto, se analiza el experimento de Stern-Gerlach que se analiza en la referencia {\cite{peres1997quantum}}.}
...
\rrnote{ Párrafo: Definir una medición difusa como una medición no ideal.}
