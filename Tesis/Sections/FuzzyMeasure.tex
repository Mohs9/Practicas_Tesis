...
a ver que otra notacion usa la gente} \rrnote{ Lo cambié por como lo vi en algunos libros y en internet. }
...
frase (y otra mas adelante de este párrafo)}
...
medición y un sistema cuántico, que contiene el estado posterior a la medición.
Esto es muy conveniente debido a que es una forma resumida de caracterizar
totalmente la medición difusa y no es necesario considerar mediciones
selectivas. 
