...
\rrnote{Los operadores de proyección no son suficiente para describir
...
Es posible utilizar el valor esperado calculado en la ecuación \ref{eq:Expected-Value-FM-2p-desarrollo} y reescribirlo de la siguiente forma \begin{equation}\label{eq:ordenar-valoresperado-povm}\begin{split}
