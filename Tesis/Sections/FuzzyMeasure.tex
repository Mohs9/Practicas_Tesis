...
\cpnote{Cual es la utilidad? porque aca?} \rrnote{Más bien es revisitar la
utilidad pero para las mediciones difusas particularmente, son útiles porque
con ellas es posible realizar el mapeo de probabilidades de forma selectiva.}
\cpnote{Nop entiendo. Croe que quizá nos toca hablar de este punto. Preparate y
...
explicitamente que quieres decir.} \rrnote{Lo que pensaba era detallar cómo
usar la ecuación \ref{eq:Expected-Value-FM-2p-desarrollo} desarrollándola para
encontrar primero los operadores POVM y luego mencionar que se debe hacer una
descomposición apropiada pueden obtenerse los operadores de Kraus. Sin embargo
creo que llevará más de un párrafo o  no sé si sería más apropiado para el
proximo capitulo.  }
