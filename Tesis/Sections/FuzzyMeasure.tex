...
\rrnote{Esqueleto: Finalmente, describir como se usará el operador difuso y el valor esperado para obtener las medidas POVM y los  operadores de Kraus, en un sistema de dos partículas para simplificar la explicación (EN el siguiente capítulo se extiende a un sistema más complejo).}
