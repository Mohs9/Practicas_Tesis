...
\cpnote{Me da cosa que esto lo copiaste textual de algun lado. No lo entiendo.}\rrnote{Sí,lo habia tomado casi literal del libro de A. Peres, el ejemplo trata sobre señales débiles que causan un conflicto con el detector y se agrega un aparato que mide al detector}
% Además, el resultado final no puede ser registrado por un sistema cuántico, que puede estar en una superposición de estados propios \cpnote{Porque no?}. 
 El detector  tiene que <<medirse>> por un aparato adecuado al que se le llama <<el medidor>>, que luego produce otra señal clásica\cpnote{El detector
no mide? como?}.
...
propio de sigma z}\rrnote{Agregué algunas oraciones y quité otras}. Sino que viene dado por el lado derecho de la ecuación {\eqref{ejemplo-fm-peres}}, evaluada en $q = q_0$. La
