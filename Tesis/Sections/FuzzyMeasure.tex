...
\end{split}\end{equation}siendo $\mathcal{H}$ el conjunto de operadores de
densidad. Este proceso constituye el mapeo de resultados o la función de
...
a ver que otra notacion usa la gente}
