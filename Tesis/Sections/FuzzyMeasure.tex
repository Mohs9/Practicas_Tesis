...
\rrnote{Esqueleto Intro: En esta sección se introduce el concepto de instrumento cuántico. Se explica la función de ellos además de detallar en cómo se calcula el valor esperado del instrumento y la razón de emplearlos. Además se especifican las dos alternativas que se usan.}
...
medición y un sistema cuántico, que contiene el estado posterior a la medición. Esto es muy conveniente debido a que es una forma resumida de caracterizar totalmente la medición difusa y no es necesario considerar mediciones selectivas. 
