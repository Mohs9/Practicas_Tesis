...
En este apartado se revisitan las medidas POVM y los operadores de Kraus conjuntamente. Debido a que el formalismo de las mediciones ideales es insuficiente para describir mediciones imperfectas, en esta sección se introduce la forma en la que se implementan las medidas generalizadas, con el fin de explicar cómo se emplearán estas herramientas para asegurar una especificación completa de las mediciones difusas.
...
\rrnote{Esqueleto: Explicar la relación de los operadores de Kraus y con las medidas POVM\@. Para describir una medida difusa también se necesita el estado posterior a la medición y este no puede ser especificado solamente por una medida POVM\@. Es por ello que para describir el efecto de la medición difusa en un estado de entrada $\rho$, es conveniente establecer un conjunto de operadores de Kraus $\{K_\alpha\}$ tales que $E_\alpha=K_\alpha^\dagger K_\alpha$ }
