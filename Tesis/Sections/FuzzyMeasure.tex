...
\rrnote{Esqueleto: Los POVM y los operadores de Kraus se hablaron en el marco teórico y se verán en las implementciones. En esta parte se mencionará como utilizar los operadores POVM y los operadores de Kraus conjuntamente en mediciones imperfectas y específicamente en mediciones difusas}

\rrnote{Esqueleto: En este parrafo dar la razon por que los operadores de proyeccion son insuficientes para describir completamente una medición difusa.}
