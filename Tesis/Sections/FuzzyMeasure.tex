...
\rrnote{Incluir imagenes de algún ejemplo de una medición difusa en un sistema específico. Tomar en cuenta consideraciones experimentales. Imágenes que ilustren dos partículas, con algun diagrama de cajas en las que se realiza una medición del un observable particular. Primero mostrar una medicion ideal en un sistema de dos partículas. Luego, en una segunda imagen agregar un diagramas que represente la matriz swap y obtener salidas intercambiadas  con cierta probabilidad.}
