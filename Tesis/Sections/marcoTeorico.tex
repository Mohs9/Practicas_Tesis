...
Para estudiar la completa descripción \cpnote{redundante} de las mediciones difusas para sistemas
...
\cpnote{Esto lo vas a ocupar en la tesis?}
...
discutirá acerca de los operadores POVM\@.\cpnote{repetitivas las ultimas frases}
...
\cpnote{Esto ya lo habías dicho. Porfa dale una pasada y trata de no repetir conceptos}
...
{\cite{2007geometry}}. \cpnote{redaccion}
...
\end{equation}
\cpnote{Para que este parrafo? Además esta raro de redaccion}
...
{\cite{2007geometry}}.
\cpnote{Para que queremos decir esto?}
% }}}
\subsection{Operadores POVM}\label{subsec:operadoresPOVM} % {{{
\cpnote{Lo de las mediciones ya lo has dicho varias veces. Vas a tener que darle una organizada
a la intro para no repetir ideas y que quede un poco mejor. }
