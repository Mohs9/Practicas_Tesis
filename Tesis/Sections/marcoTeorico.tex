...
\rrnote{quité algunas secciones y dejé solo 4 páginas.}
...
diferentes procesos físicos pueden dar lugar a la misma dinámica del sistema. \cpnote{no veo que tiene que ver eso aca. 
Croe que hay mas justificaciones}\rrnote{quité la justificación anterior, sin embargo no veo otra que sea útil}. Nielsen y Chuang
