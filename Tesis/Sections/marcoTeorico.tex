\chapter[OPERADORES DE DENSIDAD Y OPERACIONES CUÁNTICAS]{1. OPERADORES DE DENSIDAD Y OPERACIONES CUÁNTICAS}\label{cap1:MarcoTeorico}
...
\end{equation} 
la acción de la traza parcial es como sigue: 
\begin{equation}
	\begin{split}
...
diferentes procesos físicos pueden dar lugar a la misma dinámica del sistema.
Nielsen y Chuang {\cite{nielsen_chuang_2010}} proponen formalmente el siguiente
teorema.
...
Esta operación $\E$ representa $1/2$ de probabilidad de aplicar el operador identidad y $1/2$ de probabilidad de aplicarle $Z$ al sistema cuántico y
\begin{equation}
    \begin{array}{ccc}
        M_1=\begin{bmatrix}
            1&0\\
...
\begin{equation} 
    ...
    \end{split}
\end{equation}
%Esto está asociado a un cambio de base en el entorno, sin embargo, esto no influye en el resultado, ya que sé está trazando sobre el sistema del entorno.
% }}}
% }}}
% }}}
\begin{comment}
