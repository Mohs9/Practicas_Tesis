...
\cpnote{Que es lo que quieres decir en este parrafo? Para que lo qiueres decir?}
\rrnote{La primera oración estaba demás, sin embargo lo demás del párrafo me parece útil para la sección 4 del capitulo 2, en donde pensaba hablar de los operadores de Kraus y POVMs. Aunque creo que sería mejor solo mencionarlo en el siguiente capítulo} Los POVM se ajustan en el marco general del postulado de la medición cuántica, ya que se puede elegir $E_m=M_m M_m^{\dagger}$. Sin embargo es importante notar que los POVM no determinan los operadores de
