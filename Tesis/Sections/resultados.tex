...
Con fines ilustrativos, en este apartado se presentan los resultados principales obtenidos al trabajar con las siguientes condiciones. Inicialmente, el estado del sistema es $\rho  \in \mathcal{H}$ \cpnote{porque un estado
factorizable?}\rrnote{agregué que se trebajar con estas condiciones en esta sección.},  en él  se quiere realizar la medición de un observable factorizable 
