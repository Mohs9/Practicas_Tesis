...
% }}}
% }}}
\cpnote{HAsta aca la cosa va bien}
\subsection{Equivalencia de los instrumentos}\label{subsec:Equivalencia } % {{{
\rrnote{Esqueleto Intro: Se hace una comparación entre los instrumentos anteriores y se expone que resultaron no ser equivalentes. En esta sección se comenta que se esperaba que los instrumentos fueran equivalentes pero resultaron distintos y por ello vale la pena proponer en qué condiciones sí lo son.}
...
\rrnote{Esqueleto:Como primer punto se contrasta los valores esperados del primer y segundo instrumento. Se presenta la proposición que detalla las condiciones de equivalencia del valor esperado entre los dos instrumentos y su demostración.}
