...
Se le llama medición difusa al proceso en el cual al medir un sistema de varias partículas, existe una posibilidad de identificar erróneamente a las partículas. El objetivo general de este proyecto es describir completamente dichas mediciones. Para realizar la descripción es necesario un mapeo que proporcione la probabilidad obtener las posibles salidas de una medición difusa, así como el estado posterior a la medición.   
...
\rrnote{Esqueleto: Relatar que la medición en mecanica cuántica ha jugado un papel importante y que se ha logrado avanzar en este campo gracias a técnicas y herraminetas. Decir que este trabajo ofrece explorar un tipo de medición no ideal y estudiar algunas de estas herramientas.}
...
\rrnote{Esqueleto: Se explica que esta tesis se enfocará en una medición no ideal en particular, que son las mediciones difusas.}


\rrnote{Esuqeleto: Se presenta la estructura de los tres capítulos.}

 
\rrnote{ Esqueleto: En el primer capitulo se expone el marco conceptual para analizar mediciones}

\rrnote{Esqueleto: En el segundo capitulo se presenta el problema de las mediciones difusas y las herramientas concretas que se usarán en el trabajo.}


\rrnote{Esqueleto; En el tercer capítulo se abordan los resultados que se han obtenido, empezando en sistemas de dos partículas y generalizando para más partícualas.}
\begin{comment}
...
%principalmente el operador de densidad, las medidas POVM y la teoría de las operaciones cuánticas En este proyecto, se estudiará la . Se usará el informe final de prácticas como base inicial así como  otras fuentes especializadas para comprender y analizar algunos teoremas y temas puntuales.
