...
\begin{center}
{\setlength{\baselineskip}{1.3\baselineskip} \large \textbf{\MakeUppercase{Protocolo de tesis:Mediciones difusas en sistemas cuánticos de \boldmath{$N$} partículas}}\par}
...
%En los siguientes  tres capítulos se expone un marco que facilita la comprensión del proceso de medición, diseñado específicamente para mediciones difusas
%\cpnote{me parece que sobra esta frase, o no entiendo para que la pones. reformula, o quita} \rrnote{quite es frase} 
...
%\cpnote{Veo este capitulo muy parecido a la introduccion. Que es lo que va en uno y  que es lo que va en otro? Puedes pensarlo y platicamos? Dejo las correcciones de esto  para cuando lo tengamos claro}
...
%\cpnote{Otra vez acá es la repeticion de lo anterior. Debemos platicar un poco a ver que es lo que se quiere hacer en cada parte de este documento. }
...
para describir completamente una medición difusa.%\cpnote{Pero si ya ahblaste de las herramientoas en el primer capitulo... que las distingue de las anteriores?}\rrnote{Lo siento, quise decir que aca se hablará de cómo se aplicarán}.
