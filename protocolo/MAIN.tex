...
\rrnote{Esuqeleto: Se presenta la estructura de los tres capítulos. En el
primer capitulo se expone el marco conceptual para analizar mediciones. En el
segundo capitulo se presenta el problema de las mediciones difusas y las
herramientas concretas que se usarán en el trabajo. En el tercer capítulo se
abordan los resultados que se han obtenido, empezando en sistemas de dos
partículas y generalizando para más partícualas.}
\begin{comment}
